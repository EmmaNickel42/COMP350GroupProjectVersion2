class TutorialScreen {
  ...
  void drawTut() {
    ...
    text("You dream of being the best security developer known to mankind.\n"
      ...
      + "If safe packets enter your server, your reputation increases.\n"
      + "If an unsafe packet enters, your server will lose health and you will lose reputation.\n"
      + "There are power ups you can click on in order to help you out.\n"
